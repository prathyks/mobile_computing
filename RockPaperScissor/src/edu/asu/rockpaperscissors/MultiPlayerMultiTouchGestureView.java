...
public class MultiPlayerMultiTouchGestureView extends View{
	private static final int SIZE = 60;
	private static final String TAG=MultiPlayerMultiTouchGestureView.class.getName();
	...
	public MultiPlayerMultiTouchGestureView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	protected void playAndupdateDb(Choice choice) {
		MultiPlayerPlayAreaActivity activity = (MultiPlayerPlayAreaActivity)getContext();
		Session session = new Session(activity);
		String result = session.getusename()+","+choice.getVal();
		activity.sendMessage(result);
	}
